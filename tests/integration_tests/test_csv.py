...
def test_get_files_route(test_client):
    """
    ...
    test_client
    """
    result = test_client.get('/api/csv/get_files')
...
def test_get_csv_data_file_one(test_client):
    """
    ...
    test_client
    """
    result = test_client.get('/api/csv/get_csv_data/trade_sample_1.csv')
    json_result = json.loads(result.data)
...
def test_get_csv_data_file_two(test_client):
    """
    ...
    test_client
    """
    result = test_client.get('/api/csv/get_csv_data/trade_sample_2.csv')
    json_result = json.loads(result.data)
...
def test_get_csv_data_file_three(test_client):
    """
    ...
    test_client
    """
    result = test_client.get('/api/csv/get_csv_data/trade_sample_3.csv')
    json_result = json.loads(result.data)
